...
inout_declaration
	...
	| 'inout' reg_type 'signed'? range_? list_of_port_identifiers
	;

input_declaration
	: 'input' net_type? 'signed'? range_? list_of_port_identifiers
	| 'input' reg_type 'signed'? range_? list_of_port_identifiers
	;

output_declaration
	: 'output' net_type? 'signed'? range_? list_of_port_identifiers
	| 'output' reg_type 'signed'? range_? list_of_variable_port_identifiers
...
string_declaration
	: 'string' list_of_variable_identifiers ';'
	;
...
integer_declaration
	: integer_type 'unsigned'? list_of_variable_identifiers ';'
	;
...
reg_declaration
	: reg_type 'signed'? range_? list_of_variable_identifiers ';'
	;
...
function_declaration
	...
	| 'export' STRING_LITERAL 'context'? 'function' function_range_or_type function_identifier ';'
	;
...
task_declaration
	...
	| 'export' STRING_LITERAL 'context'? 'task' task_identifier ';'
	;
...
tf_output_declaration
	: 'output' reg_type? 'signed'? range_? list_of_port_identifiers
...
block_item_declaration
	: attribute_instance* reg_declaration
