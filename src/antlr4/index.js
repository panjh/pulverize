...
export default {
    atn, dfa, context, misc, tree, error, Token, CommonToken, CharStreams, CharStream, InputStream, FileStream, TokenStream, BufferedTokenStream, CommonTokenStream, Lexer, Parser,
    ParserRuleContext, Interval, IntervalSet, LL1Analyzer, Utils, TokenStreamRewriter
};

export {
    Token, CommonToken, CharStreams, CharStream, InputStream, FileStream, TokenStream, BufferedTokenStream, CommonTokenStream, Lexer, Parser,
